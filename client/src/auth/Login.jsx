...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (token) {
        ...
        navigate(role === "instructor" ? "/instructordashborad" : "/studentdashborad");
      } else {
  ...
  const inp = "w-full px-3.5 py-2.5 bg-[#FAFAF9] border border-[#E4E2DC] rounded-[10px] text-sm text-[#1A1A1A] placeholder-[#BDBAB4] focus:outline-none focus:border-[#3B8C5A] focus:bg-white transition disabled:opacity-60";
      ...
      <header className="bg-white border-b border-[#EAE8E3]">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <p className="text-[13px] text-[#888]">
            ...
            <Link to="/register" className="text-[#3B8C5A] font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="bg-white rounded-2xl border border-[#EAE8E3] px-8 py-9 shadow-sm">
            ...
            <div className="text-center mb-7">
              <h1 className="text-[22px] font-semibold text-[#1A1A1A] tracking-tight">Welcome back</h1>
              <p className="text-[13px] text-[#999] mt-1">Sign in to continue learning</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  <label className="text-[12.5px] font-medium text-[#444]">Password</label>
                  <button type="button" className="text-[12px] text-[#3B8C5A] hover:underline">
                    Forgot password?
                  </button>
                </div>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <div className="border border-[#EAE8E3] rounded-[10px] p-3 text-center">
                ...
                <p className="text-[11.5px] font-medium text-[#555] mt-1">I'm a Student</p>
                <p className="text-[10.5px] text-[#AAA]">Browse &amp; learn</p>
              </div>
              <div className="border border-[#EAE8E3] rounded-[10px] p-3 text-center">
                <i className="ti ti-chalkboard text-[#B07A1A] text-[18px]" />
                <p className="text-[11.5px] font-medium text-[#555] mt-1">I'm an Instructor</p>
          ...
          <p className="text-center text-[12px] text-[#AAA] mt-5">
            ...
            <span className="text-[#3B8C5A] hover:underline cursor-pointer">Terms</span>
            {" "}&amp;{" "}
            <span className="text-[#3B8C5A] hover:underline cursor-pointer">Privacy Policy</span>
          </p>
        </div>
      </div>
    </div>
